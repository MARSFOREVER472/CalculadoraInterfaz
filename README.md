...
En este proyecto, se muestra cómo desarrollar el código fuente de una calculadora que realiza las siguientes operaciones aritméticas: sumar, restar, dividir, multiplicar. Lo hacemos desde cero, empleando las tecnologías de un desarrollador Front-End HTML, CSS y nos centraremos principalmente en el desarrollo del código fuente Javascript.
